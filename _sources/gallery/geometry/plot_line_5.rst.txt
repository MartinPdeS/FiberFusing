...
.. "gallery/geometry/plot_line_5.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_geometry_plot_line_5.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_geometry_plot_line_5.py:
...
.. image-sg:: /gallery/geometry/images/sphx_glr_plot_line_5_001.png
   :alt: Coupler index structure, Rasterized mesh
   :srcset: /gallery/geometry/images/sphx_glr_plot_line_5_001.png
...
.. _sphx_glr_download_gallery_geometry_plot_line_5.py:
